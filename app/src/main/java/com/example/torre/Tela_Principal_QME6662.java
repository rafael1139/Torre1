...
public class Tela_Principal_QME6662 extends AppCompatActivity {

    private Button bt_deslogar,bt_confirmar,bt_pneu_atual;
    private static final String TAG = "Tela_Principal_QME6662";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_principal_qme6662);
        ...
        bt_deslogar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Principal_QME6662.this, Tela_Principal.class);
        ...
        bt_pneu_atual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Principal_QME6662.this, Tela_Secundaria_QME6662.class);
                startActivity(intent);
                finish();
        ...
        bt_confirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pneu_dd.isEmpty() || pneu_de.isEmpty() || pneu_trd1.isEmpty()|| pneu_trd2.isEmpty()|| pneu_tre1.isEmpty()|| pneu_tre2.isEmpty() || date.isEmpty() || pneu_trd3.isEmpty()
                        || pneu_trd4.isEmpty() || pneu_tre3.isEmpty() || pneu_tre4.isEmpty()){
    ...
    private void SalvarDadosUsuario(View v){
        ...
        DocumentReference documentReference = db.collection("Pneus").document("QME6662");
