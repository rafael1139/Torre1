...
public class Tela_Secundaria_QME5781 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_secundaria_qme5781);
        IniciarComponente();
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Secundaria_QME5781.this, Tela_Principal.class);
