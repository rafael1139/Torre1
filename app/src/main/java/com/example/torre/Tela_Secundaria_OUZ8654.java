...
public class Tela_Secundaria_OUZ8654 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_secundaria_ouz8654);
        IniciarComponente();
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Secundaria_OUZ8654.this, Tela_Principal.class);
