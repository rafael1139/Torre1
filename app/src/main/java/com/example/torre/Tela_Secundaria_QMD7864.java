...
public class Tela_Secundaria_QMD7864 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_secundaria_qmd7864);
        IniciarComponente();
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Secundaria_QMD7864.this, Tela_Principal.class);
