...
public class Tela_Secundaria_QMD7866 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_secundaria_qmd7866);
        IniciarComponente();
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Secundaria_QMD7866.this, Tela_Principal.class);
