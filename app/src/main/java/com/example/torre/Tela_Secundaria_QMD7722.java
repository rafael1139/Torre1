...
public class Tela_Secundaria_QMD7722 extends AppCompatActivity {


    FirebaseFirestore db = FirebaseFirestore.getInstance();
    private TextView edit_dd,edit_de,edit_tr_dd1,edit_tr_dd2,edit_tr_de1,edit_tr_de2,data,nome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_secundaria_qmd7722);
        IniciarComponente();
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Secundaria_QMD7722.this, Tela_Principal.class);
