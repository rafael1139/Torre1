...
public class Tela_Principal_NYH5704 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_principal_nyh5704);
        ...
        bt_deslogar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Principal_NYH5704.this, Tela_Principal.class);
        ...
        bt_pneu_atual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Principal_NYH5704.this, Tela_Secundaria_NYH5704.class);
                startActivity(intent);
                finish();
    ...
    private void SalvarDadosUsuario(View v){
        ...
        DocumentReference documentReference = db.collection("Pneus").document("NYH5704");
