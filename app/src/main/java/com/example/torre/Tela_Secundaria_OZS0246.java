...
public class Tela_Secundaria_OZS0246 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_secundaria_ozs0246);
        IniciarComponente();
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Secundaria_OZS0246.this, Tela_Principal.class);
