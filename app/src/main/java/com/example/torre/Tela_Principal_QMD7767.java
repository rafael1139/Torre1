...
public class Tela_Principal_QMD7767 extends AppCompatActivity {

    private Button bt_deslogar,bt_confirmar,bt_pneu_atual;
    private static final String TAG = "Tela_Principal_QMD7767";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_principal_qmd7767);
        ...
        bt_deslogar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Principal_QMD7767.this, Tela_Principal.class);
        ...
        bt_pneu_atual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Tela_Principal_QMD7767.this, Tela_Secundaria_QMD7767.class);
                startActivity(intent);
                finish();
    ...
    private void SalvarDadosUsuario(View v){
        ...
        DocumentReference documentReference = db.collection("Pneus").document("QMD7767");
